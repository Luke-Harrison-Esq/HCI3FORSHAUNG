    ...
    <div className="flex flex-col pb-3 bg-white max-w-[346px]">
      <div className="flex flex-col w-full bg-white shadow-sm">
        ...
        <input
          ...
          className="justify-center self-center py-1 pr-1 pl-3 mt-3 w-full text-sm whitespace-nowrap rounded-md border border-solid border-black border-opacity-10 max-w-[322px] text-black text-opacity-50"
        />
        <div className="flex gap-2 justify-between items-center px-16 py-12 mt-3 text-base font-medium leading-6 text-center text-black rounded-md bg-black bg-opacity-10">
            <button
                onClick={() => {
            ...
            >
                User would be prompted to add profile picture (not implementing this right now because images cause
                crashes without a way to save them properly)
            </button>
            <img
                loading="lazy"
                src=""
          ...
          <input
              type="text"
              placeholder="This is your Bio please add write about yourself"
              className="justify-center self-center py-1 pr-1 pl-3 mt-3 w-full text-sm whitespace-nowrap rounded-md border border-solid border-black border-opacity-10 max-w-[322px] text-black text-opacity-50"
        />
        <input
          type="text"
        ...
        <input
          ...
          className="justify-center self-center py-1 pr-1 pl-3 mt-3 w-full text-sm whitespace-nowrap rounded-md border border-solid border-black border-opacity-10 max-w-[322px] text-black text-opacity-50"
        />
        <Link to="/AddListing" className="justify-center items-center self-center px-16 py-2.5 mt-3 w-full text-base font-medium leading-6 text-white whitespace-nowrap bg-black rounded-lg max-w-[312px]">
          Add a listing
        </Link>
        <Link to="/" className="justify-center items-center self-center px-16 py-2.5 mt-3 w-full text-base font-medium leading-6 text-white whitespace-nowrap bg-black rounded-lg max-w-[312px]">
          Finish
        </Link>
      </div>
